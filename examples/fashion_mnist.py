...
class Net(nn.Base):
  def __init__(self):
    self.l1 = nn.Linear(784, 128, dtype=minigrad.dtypes.float32)
    self.l2 = nn.Linear(128, 10, dtype=minigrad.dtypes.float32)
...
if __name__ == "__main__":
  dataset = nn.DataSet("fashion_mnist", to_tensor=True)
